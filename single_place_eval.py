...
class DeterministicModel(DeterministicMixin, Model):
    def __init__(self, observation_space, action_space, device):
        ...
        self.rnn = nn.RNN(input_size=34, hidden_size=256, num_layers=2, batch_first=True)
...
path = "/home/takenami/sim2real_ros2/runs/torch/Isaac-Turtlebot3-Image-Place-Direct-v0/25-12-01_23-13-33-708503_PPO/checkpoints/agent_200000.pt"
agent.load(path)
